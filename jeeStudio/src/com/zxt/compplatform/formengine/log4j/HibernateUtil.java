...
public class HibernateUtil {
	...
	static {
		...
		try {
			...
			// ApplicationContext context=new
			// FileSystemXmlApplicationContext("D:/Projects/TFSJava/Brood/Code/CMS/WebContent/WEB-INF/applicationContext.xml");
			// SESSION_FACTORY =
			// (SessionFactory)context.getBean("sessionFactory");
			ApplicationContext context = WebApplicationContextUtils
					.getRequiredWebApplicationContext(ServletActionContext
							.getServletContext());// sessionfactory随便用哪种方式如果是web开发就用webApp得吧
			SESSION_FACTORY = (SessionFactory) context
