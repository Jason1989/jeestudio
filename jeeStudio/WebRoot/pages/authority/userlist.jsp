	...
	<script type="text/javascript">
		$(function(){
			$('#bd_usertablelist_table').datagrid({
				...
				columns:[[
					{field:'username',title:'级别名',align:'center',width:120},
					{field:'uname',title:'级别号',align:'center',width:120},
					{field:'sex',title:'管理用户',align:'center',width:150},
				...
				rownumbers:true,
				 toolbar: ['-', 
		  			{text: '添加级别',iconCls: 'icon-add',handler: userAdd},
		  			'-', 
		  			{text: '删除级别',iconCls: 'icon-remove',handler: userDelete}, 
		  			'-',
		  			{text: '修改级别',iconCls: 'icon-search',handler: userSelect}, 
		  			'-'
		  			]
