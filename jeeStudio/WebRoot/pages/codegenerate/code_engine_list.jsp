	...
	<script>
        ...
        $(function(){
            $('#fd_formlist_table').datagrid({
                height: 400,
                nowrap: false,
                url:'codegenerate/engineCodeGenerate!getFormsData.action',
                striped: true,
                autoFit: true,
                sortName: 'id',
                idField: 'id',
                ...
                columns: [[ {
					...
					formatter:function(value,rec){
					    var foId = rec.id;
					    var links = '<a href="javascript:void(0)"  onclick=openEngineCodeGuide("'+foId+'")>固化1</span>&nbsp;&nbsp;|&nbsp;&nbsp;';
        ...
        function openEngineCodeGuide(formsId){
          var url = "codegenerate/engineCodeGenerate!goGenerate.action?form_id="+formsId;
        ...
        function engineCodeGenerate(){
           $('#fd_code_form').form("submit",{
			    url:'codegenerate/engineCodeGenerate!generate.action',
			    onSubmit:function(){
        ...
        function openCodeLog(formId){ 
          ...
          $('#fd_formlist_tab').tabs('add',{
						title:'表单日志', 
						href:'codegenerate/engineCodeGenerate!goLogs.action?form_id='+formId,
						closable:true
					});
        }
        function closeWin(){
