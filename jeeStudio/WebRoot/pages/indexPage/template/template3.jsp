...
<div class="easyui-panel" fit="true" border="false" style="padding-right:5px;">
	<div class="easyui-layout" style="height: 510px;">
		<div region="north" border="false" style="height:255px;">
			<div class="easyui-layout" fit="true" border="false">
				<div region="west" border="false" style="width:${clientWidth*0.35}px;" class="index_model_padding">
					<c:choose>
				...
				<div region="center" border="false"  class="index_model_padding">
				 ...
				 <div region="east" border="false" style="width: ${clientWidth*0.35}px;" class="index_model_padding">
			    	<c:choose>
...
<div class="easyui-panel" fit="true" border="false" style="padding-right:5px;">
	<div class="easyui-layout" style="height: ${clientHeight*0.8}px;">
		<div region="north" border="false" style="height:${clientHeight*0.4}px;">
			<div class="easyui-layout" fit="true" border="false">
				<c:if test="${not empty divmap['node1'].url}">
					<div region="west" border="false" style="width:${clientWidth*0.35}px;" class="index_model_padding">
							<div class="easyui-panel" icon="icon-menu" border="true" fit="true" href="${divmap['node1'].url}" title="${divmap['node1'].name}"></div>
					</div>
				</c:if>
			    <!-- center必须显示  -->
				<div region="center" border="false"  class="index_model_padding">
					<c:if test="${not empty divmap['node2'].url}">
						<div class="easyui-panel"  icon="icon-menu" border="true" fit="true" href="${divmap['node2'].url}" title="${divmap['node2'].name}" ></div>
					</c:if>
				</div>
				<c:if test="${not empty divmap['node3'].url}">
			   	 	<div region="east" border="false" style="width: ${clientWidth*0.35}px;" class="index_model_padding">
						<div class="easyui-panel" icon="icon-menu" border="true" fit="true" href="${divmap['node3'].url}" title="${divmap['node3'].name}" ></div>
			   		 </div>
				</c:if>
			</div>    
		</div>
		<div region="center" border="false">
			<div class="easyui-layout" fit="true" border="false">
				<c:if test="${not empty divmap['node4'].url}">
					<div region="west" border="false" style="width:${clientWidth*0.35}px;" class="index_model_padding">
							<div class="easyui-panel" icon="icon-menu" border="true" fit="true" href="${divmap['node4'].url}" title="${divmap['node4'].name}"></div>
					</div>
				</c:if>
			    <!-- center必须显示  -->
				<div region="center" border="false"  class="index_model_padding">
					<c:if test="${not empty divmap['node5'].url}">
						<div class="easyui-panel" icon="icon-menu" border="true" fit="true" href="${divmap['node5'].url}" title="${divmap['node5'].name}" ></div>
					</c:if>
				</div>
				<c:if test="${not empty divmap['node6'].url}">
			    	<div region="east" border="false" style="width: ${clientWidth*0.35}px;" class="index_model_padding">
						<div class="easyui-panel" icon="icon-menu" border="true" fit="true" href="${divmap['node6'].url}" title="${divmap['node6'].name}" ></div>
			   		 </div>
				</c:if>
			</div>
		</div>
