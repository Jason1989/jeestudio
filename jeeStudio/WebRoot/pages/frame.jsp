...
<html>
  <head>
	...
	<script type="text/javascript" src="js/jquery.easyui.min.update.js"></script>
...
<body class="easyui-layout">
	...
	<div id="contents" region="west" split="true" title="菜单栏" style="width:180px;" href="menu/menu.action"></div>
	<div id="main"     region="center" href="pages/default_main.jsp"></div>
