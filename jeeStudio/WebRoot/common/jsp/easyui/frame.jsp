...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="jquery-easyui-1.1.2/themes/easyui.${themes}.css"/>
	...
	<script>
		...
		$(function(){
	       ...
	       $(".change_skin_button").live('click',function(){
	           ...
	           if("blue" == theme || "green" == theme || "dgreen"==theme|| "deepblue"==theme|| "yingji"==theme || "gray"==theme  ){
	           		if("${themes}" == theme){
  ...
  <body class="easyui-layout index" style="visibility: hidden;" id="body">	
		<!-- top -->
		<jsp:include page="/common/jsp/easyui/frame_top.jsp"></jsp:include>
		<!-- 角色选择界面 -->
		<!-- 底部 -->
		<div region="south" border="false" split="true" style="height:35px;padding:0px;background:#f5f5f5;">
			<div class="bottom">
				<div class="bottom_font" align="center">&copy; 版权所有：${systemName}</div>
			</div>
		</div>
		<!--左部的菜单-->	
