...
$("<td><a href=\"javascript:void(0)\" icon=\"pagination-go\" title=\"跳转到\"></a></td>").appendTo(tr);
if(_5c.showRefresh){
$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
...
//added by bozch 2011-7-23
_5d.find("a[icon=pagination-go]").unbind(".pagination").bind("click.pagination",function(e){
var _val_60=parseInt(_5d.find("input.pagination-num").val())||1;
_62(_5b,_val_60);
});
...
_6c=_6c.replace(/{total}/,_6a.total);_6c=_6c.replace(/{pages}/,_6b);
...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:false,showRefresh:true,onSelectPage:function(_75,_76){
...
function _c2(_c3,ul,_c4,_c5){
	...
	function _c9(ul,_cc,_cd){
		if(_cc != null)//added by bozch 2011-01-06
...
function _104(_105){
var _106=[];
$(_105).find(".tree-checkbox1,.tree-checkbox2").each(function(){
...
var opts=$.extend({showType:"slide",showSpeed:600,width:250,height:100,msg:"",title:"",iconCls:"",timeout:4000},_1e3||{});
var win=$("<div class=\"messager-body\"></div>").html(opts.msg).appendTo("body");
win.window({title:opts.title,iconCls:opts.iconCls,width:opts.width,height:opts.height,collapsible:false,minimizable:false,maximizable:false,shadow:false,draggable:false,resizable:false,closed:true,onBeforeOpen:function(){
...
$(".tabs-scroller-left, .tabs-scroller-right",_241).hover(function(){
		...
		if(className == "tabs-scroller-left"){
		...
		var className = this.className;
		if(className == "tabs-scroller-left tabs-scroller-left-over"){
...
var t=$(_279);
return {width:(parseInt(_279.style.width)||undefined),height:(parseInt(_279.style.height)||undefined),headerCls:t.attr("headerCls"),fit:(t.attr("fit")?t.attr("fit")=="true":undefined),border:(t.attr("border")?t.attr("border")=="true":undefined),plain:(t.attr("plain")?t.attr("plain")=="true":undefined)};
};
$.fn.tabs.defaults={width:"auto",height:"auto",headerCls:null,plain:false,fit:false,border:true,tools:null,scrollIncrement:100,scrollDuration:400,onLoad:function(_27a){
	...
	$.fn.validatebox.defaults={
		...
		rules:{
			...
			url:{validator:function(_2fb){
				 ...
				 * added by hgw
				 */	
				mobile:{validator:function (_2a51){
					return /^0{0,1}(13[0-9]|15[0-9]|15[5-9]|18[0-9])[0-9]{8}$/.test(_2a51);
				},message:"Please enter a valid mobile."},
				//验证不能有特殊符号只能输入汉字字母数字下划线。
				sign:{validator:function (_2s314){
				//return /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i.test(_2s314);
					var yz=/^[a-zA-Z0-9_\u4e00-\u9fa5]+$/;
					return yz.test(_2s314);
				},message:"Please enter a valid sign."},
				
				tel:{validator:function (_2a519){
					return /(^(\d{2,4}[-_ï¼â]?)?\d{3,8}([-_ï¼â]?\d{3,8})?([-_ï¼â]?\d{1,7})?$)|(^0?1[35]\d{9}$)/.test(_2a519);
				},message:"Please enter a valid tel."},
				
				
				PostalCode:{validator:function (_2a5191){
					return /(^[1-9]\d{5}(?!\d)$)/.test(_2a5191);
				},message:"Please enter a valid PostalCode."},
			
			idcard:{validator:function (_2a52){
					return /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{4}$/.test(_2a52);
			},message:"Please enter a valid idcard."},
			
			number:{validator:function (_2a53){
					return /^-?[0-9]+(.[0-9]{1,6})?$/.test(_2a53);
			},message:"Please enter a valid number."},
		    //经度 
			jingduxj:{validator:function (_2a59){
					return /^(?:88\.[4-9]\d{0,5}|89\.\d{1,6}|90.0{1,5})$/.test(_2a59);
			},message:"Please enter a valid jingduxj."},
			//纬度
			weiduxj:{validator:function (_2a60){
					return  /^(?:41\.[3-9]\d{0,5}|42\.\d{1,6}|43\.[0-7]\d{0,5})$/.test(_2a60);
			},message:"Please enter a valid weiduxj."},
			
			zipcode:{validator:function (_2a53){
					return /^[1-9]\d{5}(?!\d)$/.test(_2a53);
			},message:"Please enter a valid zipcode."},
			
			phone:{validator:function (_2a54){
					return /^((0\d{2,3})-)(\d{7,8})(-(\d{3,4}))?$/.test(_2a54);
			},message:"Please enter a valid phone."},
		
			phone_mobile:{validator:function (_2a54){
					return /^(13[0-9]{9}|[0-9]{7,8}|0[0-9]{2,3}\-[0-9]{7,8}(\-[0-9]{0-4})?)$/.test(_2a54);
			},message:"Please enter a valid phone."},
		
			price:{validator:function (_2a54){
					return /^\d+(\.\d{1,2})?$/.test(_2a54);
			...
			maxlength_isExist: {//长度加唯一验证 
			        validator: function(value, urls){
			        	var msgtest="该选项值已被占使用";
			            $.post(urls[0]+"",{name:value},function(data){
			               if(data=="unexist"){
			                  flag = true;
			                  $.data(document.body,"flag",flag);
			               }else if(data=="exist"){
			            ...
			            if(urls[1]<value.length&&(urls[1]*1)>0){
			            	flag = false;
			            	msgtest="长度不能超过"+urls[1];
			            	$.data(document.body,"flag",flag);
			            }
			            $.fn.validatebox.defaults.rules.maxlength_isExist.message = msgtest;
			            return  $.data(document.body,"flag");
			        },
			        message: '该值已被占使用,请修改'
			    },        
     ...
     resourceID: {
        validator: function (value, param) {
            return (/^[A-Za-z]+$/.test(value))&&(value.length >= param[0])&&(value.length <= param[1]);
        },
        message: '只允许英文字母。最小长度为 {0},最大长度为 {1}.'
    },
    
			    
			positive_Integer:{validator:function (_2a56){
					return /^[1-9]\d*$/.test(_2a56);
			},message:"Please enter a valid integer."},
			
			age:{validator:function (_2a56){
					return /^(120|((1[0-1]|\d)?\d))?$/.test(_2a56);
			},message:"请输入1-120之间的年龄"},
			comboRequire:{validator:function (_2a517,_2a58){
					if($.trim(_2a517)+"" == "请选择")
						return false;
					else return true;
			},message:"Please fix valide Value!"},
			compDate:{validator:function (_2a11,_2a22){
					var con = _2a22[1];
					var compdate = _2a11;
					var date = $("#"+_2a22[0]).datebox('getValue');
					if(con=='rt'){
				 ...
				 *
				 */	
			length:{validator:function(_2fc,_2fd){
...
(function($){
	/*submit the form ;_300 is "default" config and "submit" method param
	 * _300:
	 * {
	 *   onSubmit:function(){}
	 *   url:'',
	...
	function _2fe(_2ff,_300){
		...
		var form=$(_2ff);
		//add the url to the attribute "action" of form tag 
		if(_300.url){
	...
	function load(_304,data){
		...
		function _306(data){//apply the data
			var form=$(_304);
	...
	function hideComponent(_309){
		$("input,select,textarea",_309).each(function(){
			var t=this.type,tag=this.tagName.toLowerCase();
			if(t=="text"||t=="hidden"||t=="password"||tag=="textarea"){
				if($(this).hasClass('combo-value')){
					$(this).parent().hide().after($(this).parent().find('.combo-text').val());
				}else{if(t!= "hidden"){if($(this).is(":visible")){$(this).hide().after(this.value);}}}
			}else{
				if(t=="checkbox"||t=="radio"){
					//alert(this.nextSibling.nodeValue)
					//this.disabled=true;
					$(this).hide();
					if(this.checked){$(this).hide().after(this.nextSibling.nodeValue);}
					$(this.nextSibling).remove();
				}else{
					if(tag=="select"){
						if(!$(this).hasClass('combo-f')){
							$(this).hide().after($(this).find("option:selected").text());
						}}}}});
	};
	function _30a(_30b){
...
if(opts.height!="auto"){
var _38e=_387-_389.children("div.datagrid-header").outerHeight(true)-_389.children("div.datagrid-footer").outerHeight(true)-
wrap.children("div.datagrid-toolbar").outerHeight(true)-
					wrap.children("div.datagrid-searchbar").outerHeight(true)-wrap.children("div.datagrid-pager").outerHeight(true);
...
//toolbar add buttons align right 
//changed by bozch  2011-01-06
if(opts.toolbar){
	...
	$("div.datagrid-searchbar",_3ae).remove();
	if(opts.searchbar){
		var formId = opts.searchbar.formId;
		var form = $("<div></div>");
		if(formId && $.trim(formId) != ""){
			form.attr("id",formId);
		}
		var tb=$("<div class=\"datagrid-searchbar\"></div>").prependTo(_3ae);
		var forms = opts.searchbar.forms;
		...
		if(forms){
			...
			for(var i=0;i<forms.length;i++){
				...
				if(type == "start_end"){
					...
					if(searform.options){
						...
						var startEditor = opts.editors[startConfig.type];
						var endEditor = opts.editors[endConfig.type];
			...
			function getSearchValue(){
				...
				for(var i=0;i<searchEditors.length;i++){
					...
					if(val&&val != ""){
						$.data(search_query_data,name,val);
					}
			...
			submitButton.linkbutton({plain:false,iconCls:'icon-search'}).click(function(){
			    if(form.form('validate')){
					opts.onSearcBefore.call(_3ae,getSearchValue());
...
var _431=false;
var _432={};
var nd=_433(_42a,_42b);//get value from the editor which is changed; Loger:bozch
for(var _434 in nd){//put the change value into the rows of datagrid; Loger:bozch
if(row[_434]!=nd[_434]){
row[_434]=nd[_434];
_431=true;
_432[_434]=nd[_434];
...
var _48d={
	text:{init:function(_48e,_48f){
		var _490=$("<input type=\"text\" size=\"17\" class=\"datagrid-editable-input\">").appendTo(_48e);
		return _490;
...
}},datetimebox:{init:function(_4b9s,_4bas){
var _4bbs=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_4b9s);
_4bbs.datetimebox(_4bas);
return _4bbs;
},destroy:function(_4bcs){
$(_4bcs).datetimebox("destroy");
},getValue:function(_4bds){
return $(_4bds).datetimebox("getValue");
},setValue:function(_4bes,_4bfs){
$(_4bes).val(_4bfs);
},resize:function(_4c0s,_4c1s){
var _4c2s=$(_4c0s);
if($.boxModel==true){
_4c2s.width(_4c1s-(_4c2s.outerWidth()-_4c2s.width()));
}else{
_4c2s.width(_4c1s);
}
}},combobox:{init:function(_4c3,_4c4){
var _4c5=$("<input type=\"text\" listHeight='100'>").appendTo(_4c3);
_4c5.combobox(_4c4||{});
return _4c5;
},destroy:function(_4c6){
$(_4c6).combobox("destroy");
},getValue:function(_4c7){
	var ops = $(_4c7).combobox("options");
	if(ops.multiple){
		var vals = $(_4c7).combobox("getValues");
		if(vals){
	...
	var ops = $(_4c8).combobox("options");
	if(ops.multiple){
		if(_4c9){
			return $(_4c8).combobox("setValues",_4c9.split(","));
		}
		return;
	}else{
		return $(_4c8).combobox("setValue",_4c9);
	}
...
},onSearcBefore:function(searchdata){
},onLoadError:function(){
...
var r=init(this);
var ops = $.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_5fd);
_5ff=$.data(this,"combo",{options:ops,combo:r.combo,panel:r.panel,previousValue:null,initValue:ops.value});
$(this).removeAttr("disabled");
}
...
return jq.each(function(){
var ops = $.data(this,"combo");
if(ops.options.multiple){
_5ef(this,ops.initValue);
}else{
_5ef(this,[ops.initValue]);
}
});
...
var opts;
if(_635){
opts = $.extend(_635.options,_632);
_630(this);
}else{
opts = $.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_632);
_635=$.data(this,"combobox",{options:opts});
_630(this);
_624(this,_622(this));
...
$.data(this,"combobox", $.extend({},_635,{initValue:$(this).combobox("getValues")}));
});
};
...
return jq.each(function(){
var ops = $.data(this,"combobox");
if(ops.options.multiple){
_610(this,ops.initValue);
}else{
_610(this,[ops.initValue]);
}
...
_64e = $.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_64b)});
}
_63f(this);
$.data(this,"combotree",$.extend({},_64e,{initValue:$(this).combotree("getValues")}));
});
};
...
return jq.each(function(){
var ops = $.data(this,"combotree");
if(ops.options.multiple){
_648(this,ops.initValue);
}else{
_648(this,[ops.initValue]);
}
...
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false,onlyLeafCheck:false});
})(jQuery);
(function($){
function _652(_653){
...
_652(this);
$.data(this,"combogrid",$.extend({},_66c,{initValue:_66c.options.value}));
});
};
...
return jq.each(function(){
var ops=$.data(this,"combogrid");
if(ops.options.multiple){
_662(this,ops.initValue);
}else{
_662(this,[ops.initValue]);
}
});
...
$("<a href=\"javascript:void(0)\" class=\"datebox-clear\"></a>").html(opts.clearText).appendTo(_676);
...
_676.find(".datebox-clear").click(function(){
$(_671).combo("clear");
});
...
var opts = $.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_680);
$.data(this,"datebox",{options:opts,initValue:opts.value});
}
_670(this);
});
};
...
return jq.each(function(){
_679(this,$.data(jq[0],"datebox").initValue);
});
}};
...
_677(this,q);
}},currentText:"Today",closeText:"Close",clearText:'Clear',okText:"Ok",formatter:function(date){
...
_688.spinner.timespinner({showSeconds:opts.showSeconds}).bind("mousedown",function(e){
e.stopPropagation();
});
...
//get the date and the time from datetimebox
function _68d(_68e){
...
function _68c(_692){
	...
	var date=_68d(_692);
	_691(_692,opts.formatter(date));//formate the date and set the String date into ^
...
$.fn.datetimebox=function(_699,_69a){
	...
	return this.each(function(){
		...
		if(_69c){
			...
			var opts = $.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_699);
			$.data(this,"datetimebox",{options:opts,initValue:opts.value});
		}
		_686(this);
	});
};
...
},reset:function(jq,_69d){
return jq.each(function(){
_691(this,$.data(this,"datetimebox").initValue);
});
}};
...
$.fn.datetimebox.defaults=$.extend({},$.fn.datebox.defaults,{showSeconds:true,keyHandler:{up:function(){
	...
	var formatDate = "";
	var showSeconds = $(this).get(0).showSeconds;
	if(showSeconds){
		formatDate = $.fn.datebox.defaults.formatter(date)+" "+_69f(h)+":"+_69f(M)+":"+_69f(s);
	}else{
		formatDate = $.fn.datebox.defaults.formatter(date)+" "+_69f(h)+":"+_69f(M);
	}
	return formatDate;
},parser:function(s){
	if($.trim(s)==""){
	...
	if(showSeconds){
		...
		date = new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_6a1,_6a2);
	}else{
		date = new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_6a1);
	}
	return date;
}});
})(jQuery);
