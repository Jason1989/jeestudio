/** 
*介绍： 输入：汉字+字母  输出  汉字首字母+字母  全小写）  此为：js方式
* 参数: 
* @GUOWEIXIN
* @param1 所传的汉字；
* @param2 所传的拼音/汉字； 
* @return Array
* 调用方式: var array=pinyinParse("中国","china"); 得到结果： array[0]="zg"  array[1]="c"
*/ 
function pinyinParse(param1,param2){
			var arrayS=new Array();
			arrayS[0]=toPinyinOnly(param1);
			arrayS[1]=toPinyinOnly(param2).substring(0,1);
			return arrayS;
		} 
		...
		　　 　event.keyCode=9; 
					  ...
					  for (var i = ascCode; !spell[i] && i > 0;)
					   i--;
						 var rv=spell[i].substring(0,1);
					  //return (spell[i]+" ");// 这是返回了其拼音全拼，例如：你  返回：ni
           				return rv;
				   }
		}
		var spell = {
