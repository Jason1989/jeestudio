...
<div class="easyui-layout" fit="true">
   <div id="editColumn_${listPageRander}" region="center"   border="false" style="padding:10px;background:#fff;border:1px solid #ccc;height: 365px;">
	...
	<div region="south" border="false" style="text-align:center;height:55px;padding: 13px;">
		 ...
		 <a   icon='icon-ok'     class="easyui-linkbutton"     href="javascript:changeFundYearState('PARENT_APP_ID','1');dynamicSaveData('editform_${editPage.id}','fd_formlist_table_${listPageRander}','editPageWindow_${listPageRander}','queryPage_${listPage.id}','save');" >提交</a>		
